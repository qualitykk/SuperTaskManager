            ...
            modelBuilder.Entity<Task>(entity =>
            {
                ...
                entity.HasMany(d => d.Required)
                    ...
                    .UsingEntity<Dictionary<string, object>>(
                        "TaskRequires",
                        l => l.HasOne<Task>().WithMany().HasForeignKey("Required").OnDelete(DeleteBehavior.ClientSetNull).HasConstraintName("task_requires_required_fkey"),
                        r => r.HasOne<Task>().WithMany().HasForeignKey("Task").OnDelete(DeleteBehavior.ClientSetNull).HasConstraintName("task_requires_task_fkey"),
                        j =>
                        {
                ...
                entity.HasMany(d => d.TaskNavigation)
                    ...
                    .UsingEntity<Dictionary<string, object>>(
                        "TaskRequires",
                        l => l.HasOne<Task>().WithMany().HasForeignKey("Task").OnDelete(DeleteBehavior.ClientSetNull).HasConstraintName("task_requires_task_fkey"),
                        r => r.HasOne<Task>().WithMany().HasForeignKey("Required").OnDelete(DeleteBehavior.ClientSetNull).HasConstraintName("task_requires_required_fkey"),
                        j =>
                        {
                            j.HasKey("Task", "Required").HasName("task_requires_pkey");
